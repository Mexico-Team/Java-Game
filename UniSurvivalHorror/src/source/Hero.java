...
public class Hero {
	...
	private int maximumBasicAttack;
	...
	public Hero(String name, int HP, int basicAttack, int abilityPower){
		...
		this.maximumBasicAttack = basicAttack;
		this.gold = 0;
		this.mazeX = 1;
		this.mazeY = 1;
	}
	...
	//Methods
	public void heroReseter() {
		this.healthPoints = maximumHealthPoints;
		this.basicAttack = maximumBasicAttack;
		this.abilityPower = maximumAbilityPower;
		this.gold = 0;
		this.mazeX = 1;
		this.mazeY = 1;
	}
